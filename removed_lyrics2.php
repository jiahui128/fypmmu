...
<!--<div class="card shadow mb-4">
  ...
  <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
			...
			<h1 class="h3 mb-0 text-gray-800">Removed Lyrics Details</h1>
		...
		<div>
			...
			<p><i class="fas fa-exclamation-circle fa-sm"></i> Removed Lyrics Details are in below</p>
      ...
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        if(mysqli_num_rows($query_run) > 0)
        {
          ...
          <tr>
            ...
            <td>
                <form action="lyrics.php" method="post">
                <input type="hidden" name="restore_id" value="<?php echo $row['lyrics_id']; ?>">
                <button type="submit" name="restore_btn2" class="btn btn-success" OnClick="return confirm('Restore this lyrics details?')">RESTORE</button>
                </form>
            </td>
            <td>
                <form action="lyrics.php" method="post">
                  <input type="hidden" name="delete_id" value="<?php echo $row['lyrics_id']; ?>">
                  <button type="submit" name="delete_btn2" class="btn btn-danger" onClick="return confirm('Delete this lyrics details?')">DELETE</button>
                </form>
            </td>
          </tr>
          <?php
