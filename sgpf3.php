...
<body>
    ...
    <div class="row extra_margin">
		...
		<div class="col-md-4 col-sm-12 col-xs-12">
            ...
            <!-- Placeholder image -->
			<a href="javascript:void();" class="songprofilepic" data-switch="0"><img id="profilepicture" src="images/every.jpg"></a>
				
			<p class="example" style="font-family: Garamond; font-weight: bold;">Click here for music <i class='fa fa-arrow-up'></i></p>
				
			<p class="example" style="font-family: Garamond; font-weight: bold;">Album: To The Moon Original Soundtrack<br />
			Song: Everything&#180s Alright<br />
			Artist: Laura Shigihara<br />
			Released: 2011</p>
