...
<body>
    ...
    <div class="row extra_margin">
		...
		<div class="col-md-4 col-sm-12 col-xs-12">
            ...
            <!-- Placeholder image -->
			<a href="javascript:void();" class="songprofilepic" style="text-align: center;" data-switch="0"><img id="profilepicture" src="images/every.jpg"></a>
				
			<p class="example" style="text-align: left; font-family: Garamond; font-weight: bold;">Click for music <i class='fa fa-arrow-up'></i></p>
				
			<p class="example" style="text-align: left; font-family: Garamond; font-weight: bold;">Album: <br />To The Moon Original Soundtrack<br />
			Song: <br />Everything&#180s Alright<br />
			Artist: <br />Laura Shigihara<br />
			Released: 2011</p>
			
			<p><i class='fa fa-download' style="text-decoration: none;">&nbsp;&nbsp;</i><a href="songs/every.mp3" role="button" download style="text-align: left; font-family: Garamond; font-weight: bold; text-decoration: underline;">Download MP3</a></p>
			
			<br>
			
			<p><i class='fa fa-download' style="text-decoration: none;">&nbsp;&nbsp;</i><a href="pdf/songlyrics3.pdf" style="text-align: left; font-family: Garamond; font-weight: bold; text-decoration: underline;" role="button" download>Download Lyrics</a></p>
			
			<br>
			
			<!-- Social buttons using anchor elements and btn-primary class to style -->
            <p>
				<a class="btn btn-primary btn-xs" href="sgpf2.php" role="button">Previous</a>
                <a class="btn btn-primary btn-xs" href="playlist.php" role="button">Playlist</a>
				<a class="btn btn-primary btn-xs" href="sgpf4.php" role="button">Next</a>
			</p>
		...
		<p style="font-family: Times New Roman; font-weight: bold; text-align: center;">
			Short steps, deep breath<br>
			Everything is alright<br>
			Chin up, I can't<br>
			Step into the spotlight<br>
			She said, "I'm sad, "<br>
			Somehow without any words<br>
			I just stood there<br>
			Searching for an answer<br><br>
			When this world is no more<br>
			The moon is all we'll see<br>
			I'll ask you to fly away with me<br>
			Until the stars all fall down<br>
			They empty from the sky<br>
			But I don't mind<br>
			If you're with me, then everything's alright<br><br>
			Why do my words<br>
			Always lose their meaning?<br>
			What I feel, what I say<br>
			There's such a rift between them<br>
			He said, "I can't<br>
			Really seem to read you."<br>
			I just stood there<br>
			Never know what I should do<br><br>
			When this world is no more<br>
			The moon is all we'll see<br>
			I'll ask you to fly away with me<br>
			Until the stars all fall down<br>
