        ...
        <div class="row extra_margin">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="songbox">
                    ...
                    <a href="javascript:void();" class="songprofilepic" style="text-align: center;" data-switch="0"><img
                            id="profilepicture" src="images/lonely.png"></a>
                    ...
                    <p class="example" style="text-align: left; font-family: Garamond; font-weight: bold;">Album:
                        <br />JB6 <br />
                        Song: <br />Lonely<br />
                        Artist: Justin Bieber, Benny Blanco<br />
                        Released: 2020
                    </p>

                    <p><i class='fa fa-download' style="text-decoration: none;">&nbsp;&nbsp;</i><a
                            href="songs/lonely.mp3" role="button" download
                    ...
                    <p>
                        <a class="btn btn-primary btn-xs" href="sgpf18.php" role="button">Previous</a>
            ...
            <div class="col-md-8 col-sm-* col-xs-*">
                ...
                <p style="font-family: Times New Roman; font-weight: bold; text-align: center;">
                    Everybody knows my name now<br>
                    But somethin' 'bout it still feels strange<br>
                    Like lookin' in a mirror, tryna steady yourself<br>
                    And seein' somebody else<br>
                    And everything is not the same now<br>
                    It feels like all our lives have changed<br>
                    Maybe when I'm older, it'll all calm down<br>
                    But it's killin' me now<br><br>

                    What if you had it all<br>
                    But nobody to call?<br>
                    Maybe then you'd know me<br>
                    'Cause I've had everything<br>
                    But no one's listening<br>
                    And that's just f- lonely<br><br>

                    I'm so lonely<br>
                    Lonely<br><br>

                    Everybody knows my past now<br>
                    Like my house was always made of glass<br>
                    And maybe that's the price you pay<br>
                    For the money and fame at an early age<br>
                    And everybody saw me sick<br>
                    And it felt like no one gave a sh-<br>
                    They criticized the things I did as an idiot kid<br><br>
