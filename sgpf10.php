        ...
        <div class="row extra_margin">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="songbox">
                    ...
                    <a href="javascript:void();" class="songprofilepic" style="text-align: center;" data-switch="0"><img
                            id="profilepicture" src="images/moana.jpg"></a>
                    ...
                    <p class="example" style="text-align: left; font-family: Garamond; font-weight: bold;">Album: <br />
                        Moana Original Soundtrack (Disney)<br />
                        Song: <br />
                        Where You Are<br />
                        Artist: <br />
                    ...
                    <p><i class='fa fa-download' style="text-decoration: none;">&nbsp;&nbsp;</i><a
                            href="songs/whereyouare.mp3" role="button" download
                    ...
                    <p>
                        <a class="btn btn-primary btn-xs" href="sgpf9.php" role="button">Previous</a>
                        <a class="btn btn-primary btn-xs" href="playlist.php" role="button">Playlist</a>
                        <a class="btn btn-primary btn-xs" href="sgpf11.php" role="button">Next</a>
                    </p>
            ...
            <div class="col-md-8 col-sm-* col-xs-*">
                ...
                <p style="font-family: Times New Roman; font-size: 16px; font-weight: bold; text-align: center;">
                    ...
                    (Who needs a new song? This old one's all we need)<br><br>
                    This tradition is our mission<br>
                    And Moana, there's so much to do (make way)<br>
                    Don't trip on the taro root<br>
                    That's all you need<br><br>
                    We share everything we make (we make)<br>
                    We joke and we weave our baskets<br>
                    The fishermen come back from the sea<br><br>
                    I wanna see<br>
                    Don't walk away<br>
                    ...
                    And realize happiness is where you are<br><br>
                    Consider the coconut (the what?)<br>
                    ...
                    We cook up the meat inside<br><br>
                    Consider the coconuts<br>
                    The trunks and the leaves<br>
                    The island gives us what we need<br><br>
                    ...
                    You must find happiness right<br>
                    Where you are<br><br>
                    I like to dance with the water<br>
                    The undertow and the waves<br>
                    The water is mischievous<br>
                    I like how it misbehaves<br>
                    The village may think I'm crazy<br>
                    Or say that I drift too far<br>
                    But once you know what you like, well<br>
                    There you are<br><br>
                    You are your father's daughter<br>
                    Stubbornness and pride<br>
                    Mind what he says but remember<br>
                    You may hear a voice inside<br>
                    And if the voice starts to whisper<br>
                    To follow the farthest star<br>
                    Moana, that voice inside is who you are<br><br>
                    We make our nets from the fibers<br>
                    The water is sweet inside<br>
                    We use the leaves to build fires<br>
                    And cook up the meat inside<br>
                    The village believes in us<br>
                    The village believes<br>
                    The island gives us what we need<br>
                    And no one leaves<br><br>
                    ...
                    Where we are<br><br>
                    'Cause every path leads you back to<br>
                    Where you are<br><br>
                    You can find happiness right<br>
                    Where you are<br>
                    Where you are<br><br>
                </p>
