            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="songbox">
                    ...
                    <a href="javascript:void();" class="songprofilepic" data-switch="0" style="text-align: center;"><img
                            id="profilepicture" src="images/yohime.jpg"></a>
                    ...
                    <p><i class='fa fa-download' style="text-decoration: none;">&nbsp;&nbsp;</i><a
                            href="songs/onmyoji.mp3" role="button" download
                    ...
                    <p>
                        <a class="btn btn-primary btn-xs" href="sgpf13.php" role="button">Previous</a>
                        <a class="btn btn-primary btn-xs" href="playlist.php" role="button">Playlist</a>
                        <a class="btn btn-primary btn-xs" href="sgpf15.php" role="button">Next</a>
                    </p>
