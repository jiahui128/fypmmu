        ...
        foreach($query_run as $row)
        {
            ?>  
                ...
                <form action="pending.php" method="POST">
                    ...
                    <a href="pendingsongs2.php" class="btn btn-danger"> CANCEL </a>
                    <button type="submit" name="updatebtn2" class="btn btn-primary" onClick="return confirm('Update this song request details?')"> UPDATE </button>
                </form>
