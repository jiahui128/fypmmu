...
<body style="background-color:lightgray;">
    <div class="main_container login_signup_container">
        ...
        <form action="" method="POST" autocomplete="" novalidate>
            ...
            <input type="text" id="gender" name="gender" spellcheck="false" placeholder="Enter your gender" required>
            <label for="gender">Age</label>
            <input type="text" id="age" name="age" spellcheck="false" placeholder="Enter your age" required>
            <div class="post_img">
                <h4>Profile Image</h4>
                <input type="file" name="file" class="img" required>
            </div>
            <div class="post_img">
                <h4>Country</h4>
