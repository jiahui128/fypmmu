...
<li class="nav-item">
    ...
    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		...
		<div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="edit.php">Edit Admin Profile</a>
			<a class="collapse-item" href="removed_admin.php">Removed Admin Details</a>
		</div>
...
<li class="nav-item">
    ...
    <div id="collapseUsers" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		...
		<div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="userdata.php">Edit User Profile</a>
			<a class="collapse-item" href="removed_user.php">Removed Users Details</a>
		</div>
...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
		...
		<div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="pendingsongs.php">Pending Requests</a>
            <a class="collapse-item" href="completesong.php">Completed Songs</a>
			<a class="collapse-item" href="removed_pendingsongs.php">Removed Requests Details</a>
			<a class="collapse-item" href="removed_song.php">Removed Songs Details</a>
        </div>
...
<li class="nav-item">
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
		...
		<div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="lyricstable.php">Edit Lyrics Details</a>
			<a class="collapse-item" href="removed_lyrics.php">Removed Lyrics Details</a>
        </div>
