      ...
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        if(mysqli_num_rows($query_run) > 0)
        {
          ...
          <tr>
			...
			<td>
                <form action="lyrics_edit.php" method="post">
            ...
            <td>
                ...
                <button type="submit" name="remove_btn" class="btn btn-danger" onClick="return confirm('Remove this lyrics details?')">REMOVE</button>
                </form>
            </td>
          </tr>
          <?php
