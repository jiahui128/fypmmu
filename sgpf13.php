        ...
        <div class="row extra_margin">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="songbox">
                    ...
                    <p>
                        <a class="btn btn-primary btn-xs" href="sgpf12.php" role="button">Previous</a>
                        <a class="btn btn-primary btn-xs" href="playlist.php" role="button">Playlist</a>
                        <a class="btn btn-primary btn-xs" href="sgpf14.php" role="button">Next</a>
                    </p>
