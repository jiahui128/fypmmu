        ...
        foreach($query_run as $row)
        {
            ?>  
                ...
                <form action="complete.php" method="POST">
                    ...
                    <a href="completesong.php" class="btn btn-danger"> CANCEL </a>
                    <button type="submit" name="updatebtn" class="btn btn-primary" onClick="return confirm('Update this song details?')"> UPDATE </button>
                </form>
