            ...
            <div class="row">
                ...
                <div id="newreleases" class="col-md-12">
                    ...
                    <div>
                        ...
                        <form class="search" style="text-align: center; margin: auto; max-width: 630px;"
                            ...
                            <input type="text" name="query" id="query" align="center"
                                placeholder="Type the song name or code no, e.g. 1" columns="2" autocomplete="off"
                                delay="1500" onfocus="if(this.value==this.defaultValue)this.value=''"
