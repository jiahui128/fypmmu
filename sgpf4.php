        ...
        <div class="row extra_margin">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="songbox">
                    ...
                    <a href="javascript:void();" class="songprofilepic" style="text-align: center;" data-switch="0"><img
                            id="profilepicture" src="images/vibez.jpg"></a>
                    ...
                    <p class="example" style="text-align: left; font-family: Garamond; font-weight: bold;">Album:
                        <br />Nobody Is Listening<br />
                        Song: <br />Vibez<br />
                        Artist: <br />Zayn Malik<br />
                        Released: 2021
                    </p>

                    <p><i class='fa fa-download' style="text-decoration: none;">&nbsp;&nbsp;</i><a
                            href="songs/vibez.mp3" role="button" download
            ...
            <div class="col-md-8 col-sm-* col-xs-*">
                ...
                <p style="font-family: Times New Roman; font-weight: bold; text-align: center;">
                    ...
                    I've been waiting all night to get closer<br>
                    And you already know I got it for ya<br>
                    You know the vibes, know the vibes, put it on ya<br>
                    If we're moving too fast, we can slow up<br>
                    Baby, this far from mediocre (no)<br>
                    You know the vibes, know the vibes<br><br>

                    You and me here in this room<br>
                    Imagining things we could do<br>
                    Won't tell no lies, no lies to you<br>
                    I need you here, I need you here<br>
                    Mind running wild, we touching slow<br>
                    Just say the word, I'm ready to go<br>
                    Anticipation plays after four<br>
                    I need you now<br><br>

                    Baby, I'ma get you right, I will<br>
                    When I touch you tell me how it feel<br>
                    Trust me, I'ma make it feel surreal<br>
                    Baby, mind of mine<br>
                    I'ma do all the things<br>
                    Type of things that happen in your dreams<br>
                    Get you right where you need to be<br>
                    Just don't keep me<br><br>

                    Don't keep me waiting<br>
                    I've been waiting all night to get closer<br>
                    And you already know I got it for you<br>
                    You know the vibes, know the vibes, put it on ya<br>
                    If we're moving too fast, we can slow up<br>
                    Baby, this far from mediocre (no)<br>
                    You got the vibes, got the vibes<br><br>

                    If I'm movin' too fast, too fast<br><br>

                    Baby, I'ma get you right, I will<br>
                    When I touch you tell me how it feel<br>
                    Trust me, I'ma make it feel surreal<br>
                    Baby, mind of mine<br><br>
