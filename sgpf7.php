...
<body>
    ...
    <div class="row extra_margin">
		...
		<div class="col-md-4 col-sm-12 col-xs-12">
            ...
            <!-- Placeholder image -->
			<a href="javascript:void();" class="songprofilepic" data-switch="0" style="text-align: center;"><img id="profilepicture" src="images/yohime.jpg"></a>
				
			<p class="example" style="text-align: left; font-family: Garamond; font-weight: bold;">Click for music <i class='fa fa-arrow-up'></i></p>
				
			<p class="example" style="text-align: left; font-family: Garamond; font-weight: bold;">Album: Unknown<br />
			Song: <br />As A Light Smoke<br />
			Artist: IRiS (Tomo)<br />
			Released: 2020</p>
			
			<p><i class='fa fa-download' style="text-decoration: none;">&nbsp;&nbsp;</i><a href="songs/onmyoji.mp3" role="button" download style="text-align: left; font-family: Garamond; font-weight: bold; text-decoration: underline;">Download MP3</a></p>
			
			<br>
			
			<p><i class='fa fa-download' style="text-decoration: none;">&nbsp;&nbsp;</i><a href="pdf/songlyrics7.pdf" style="font-family: Garamond; font-weight: bold; text-decoration: underline;" role="button" download>Download Lyrics</a></p>
		...
		<p style="font-family: Times New Roman; font-weight: bold; text-align: center;">
			...
			君の中を　一人孤独な　影を残し　歩く<br>
			欠片ひとつ　残すことなく　生まれ変わりゆく<br><br>

			さくら散る空　ほら　輝く花火のように<br>
			私を焼いて　この世を引き裂く　何かが私を困らせる<br><br>

			あ　傷つき　苦しむのは　わたし<br>
			あ　夢に　全てを　運命よ<br><br>

			気づかされる　私を惑わすよう<br>
			知る生きの苦の的　何　ここで私は<br><br>
