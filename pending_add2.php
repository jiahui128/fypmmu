        ...
        foreach($query_run as $row)
        {
            ?>  
				...
				<div class="modal-footer">
					<a href="pendingsongs2.php" class="btn btn-danger"> CLOSE </a>
					<button type="submit" name="addbtn2" class="btn btn-primary" onClick="return confirm('Add this request as a new song?')"> ADD </button>
				</div>
                </form>
