        ...
        foreach($query_run as $row)
        {
            ?>  
                ...
                <form action="lyrics.php" method="POST">
                    ...
                    <a href="lyricstable2.php" class="btn btn-danger"> CANCEL </a>
                    <button type="submit" name="updatebtn2" class="btn btn-primary" onClick="return confirm('Update this lyrics details?')"> UPDATE </button>
                </form>
